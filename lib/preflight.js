...
const FRAMEWORK_COMMAND_BASENAMES = [
  'adopt.md', 'audit-code.md', 'audit-full.md', 'audit-infra.md',
  'brainstorm.md', 'changelog.md', 'debug.md', 'gen-skill.md',
  'gen-test.md', 'implement.md', 'investigate.md', 'kickoff.md',
  'orchestrate.md', 'plan-review.md', 'plan.md', 'preflight.md',
  'research.md', 'ship.md', 'unify.md', 'update-framework.md',
